...
# Example usage
input_dir = '/Users/emildavlityarov/Downloads/dataset/Для Хакатона'
output_dir = '/Users/emildavlityarov/Downloads/dataset/to_txt'

process_directory(input_dir, output_dir)

# Load documents from the specified directory
loader = DirectoryLoader("/Users/emildavlityarov/Downloads/dataset/to_txt", glob='*.txt')
